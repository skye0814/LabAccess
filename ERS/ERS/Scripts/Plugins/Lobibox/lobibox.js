...
//------------------------------------------------------------------------------
    ...
    Lobibox.alert = function (type, options) {
        if (["success","success_in","success_out", "error", "warning", "info"].indexOf(type) > -1) {
...
//------------------------------------------------------------------------------
    ...
    Lobibox.base.OPTIONS = {
        ...
        modalClasses: {
            ...
            'success_in': 'lobibox-success',
            'success_out': 'lobibox-info',
            'info': 'lobibox-info',
        ...
        icons: {
            bootstrap: {
                ...
                success_in: 'glyphicon glyphicon-ok-sign',
                success_out: 'glyphicon glyphicon-remove-sign',
            ...
            fontAwesome: {
                ...
                success_in: 'fa fa-check-circle',
                success_out: 'fa fa-check-circle',
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify = function (type, options) {
        if (["default", "info", "warning", "error", "success", "success_in", "success_out"].indexOf(type) > -1) {
    ...
    Lobibox.notify.OPTIONS = {
        ...
        icons: {
            bootstrap: {
                success: 'glyphicon glyphicon-ok-sign',
                success_in: 'glyphicon glyphicon-ok-sign',
                success_out: 'glyphicon glyphicon-ok-sign',
                error: 'glyphicon glyphicon-remove-sign',
                warning: 'glyphicon glyphicon-exclamation-sign',
                info: 'glyphicon glyphicon-info-sign'
            },
            fontAwesome: {
                success: 'fa fa-check-circle',
                success_in: 'fa fa-check-circle',
                success_out: 'fa fa-times-circle',
                error: 'fa fa-times-circle',
                warning: 'fa fa-exclamation-circle',
                info: 'fa fa-info-circle'
            }
