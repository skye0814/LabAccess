    ...
    var objRequestFacilityList = {
        ...
        LoadTable: function (param) {
            ...
            $("#tblRequestFacilityList").jqGrid({
                ...
                datatype: "json",
                mtype: "POST",
                colNames: ["Action", "FacilityRequestID", "RequestFacilityGUID", "Facility", "Request Date", "Start Date", "End Date", "Status", "Remarks", "Claimed Date", "Requestor"],
                colModel: [
                { name: "action", index: "action", width: 75, align: "center", sortable: false, formatter: Self.Actions, frozen: true },
                ...
                { key: false, width: 60, name: "Facility" ,index: "1", editable: true, align: "center", sortable: false, frozen: true },
                { key: false, width: 75, name: "RequestDate", index: "2", editable: true, align: "center", sortable: true, formatter: Self.FormatRequestDateTime },
                { key: false, width: 75, name: "StartTime", index: "4", editable: true, align: "center", sortable: false, formatter: Self.FormatStartTime },
                { key: false, width: 75, name: "EndTime", index: "5", editable: true, align: "center", sortable: false, formatter: Self.FormatEndTime },
                ...
                { key: false, width: 80, name: "ClaimedTime", editable: true, align: "center", sortable: false, formatter: Self.FormatClaimedTime },
                { key: false, width: 80, name: "FacilityRequestor", index: "7", editable: true, align: "center", sortable: false, hidden: true },
                ],
                toppager: $("#divPager"),
        ...
        Actions: function (cellvalue, options, rowObject) {
            ...
            var qrCodeLink = "<a href=\"\" class=\"glyphicon glyphicon-qrcode\"  onclick=\"return GenerateRequestFacilityQRCode('" + rowObject.RequestFacilityGUID + "','" + rowObject.FacilityID + "');\"></a>";

            if (rowObject.Status != "Claimed") {
                var cancelLink = "<a class=\"glyphicon glyphicon-remove-sign\"  onclick=\"return ModalConfirmationCancel(MODAL_HEADER_CANCELREQUEST, MSG_CONFIRM_CANCELREQUEST, '" + rowObject.FacilityRequestID + "');\"></a>";
            }
            else {
                var cancelLink = "";
            }
