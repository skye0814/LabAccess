$(document).ready(function () {
    ...
    header.innerHTML = `<div style='display:flex'>
                            ...
                            <span style='padding-top: 1px'>ADD CATEGORY</span>
                        </div>`;
    ...
    var objEquipmentCategoryAdd = {
        ...
        LoadTable: function (param) {
            ...
            $("#tblEquipmentCategoryList").jqGrid({
                ...
                datatype: "json",
                mtype: "POST",
                colNames: ["","Category", "Category Code", "Total", "Usable", "Defective", "Missing", "Comments"],
                colModel: [
                    { key: true, hidden: true, name: "EquipmentCategoryID" },
                    { key: false, width: 50, name: "Category", index: "2", editable: true, align: "Left", sortable: true, frozen: true },
                    { key: false, width: 50, name: "CategoryCode", index: "3", editable: true, align: "Left", sortable: true },
                    ...
                    { key: false, name: "Comments", index: "9", editable: true, align: "Left", sortable: true },
                ],
                toppager: $("#divPager"),
