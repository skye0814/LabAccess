    ...
    var objRequestEquipmentList = {
        ...
        LoadTable: function (param) {
            ...
            $("#tblRequestEquipmentList").jqGrid({
                ...
                datatype: "json",
                mtype: "POST",
                colNames: ["Action","QR","Cancel Request","RequestGUID","Request Date","Start Date","End Date","Status","Remarks","Claimed Date","Return Date","Requestor"],
                colModel: [
                    { name: "edit", index: "edit", width: 40, align: "center", sortable: false, formatter: Self.EditLink, frozen: true },
                    { name: "qrcode", hidden: true, index: "qrcode", width: 40, align: "center", sortable: false, formatter: Self.QrCodeLink, frozen: true },
                    { name: "cancel", hidden: true, index: "cancel", width: 50, align: "center", sortable: false, formatter: Self.CancelRequestLink, frozen: false },
                    { key: true, hidden: true, name: "RequestGUID", sortable: false },
                    { key: false, width: 75, name: "RequestDateTime", index: "1", editable: true, align: "center", sortable: true, formatter: Self.FormatRequestDateTime },
                    { key: false, width: 75, name: "StartTime", index: "2", editable: true, align: "center", sortable: false, formatter: Self.FormatStartTime },
                    { key: false, width: 75, name: "EndTime", index: "3", editable: true, align: "center", sortable: false, formatter: Self.FormatEndTime },
                    { key: false, width: 80, name: "Status", index: "4", editable: true, align: "center", sortable: false, formatter: Self.StatusDots },
                    { key: false, width: 60, name: "Remarks", index: "5", editable: true, align: "center", sortable: false },
                    { key: false, width: 75, name: "ClaimedTime", index: "6", editable: true, align: "center", sortable: false, formatter: Self.FormatClaimedTime },
                    { key: false, width: 75, name: "ReturnedTime", index: "7", editable: true, align: "center", sortable: false, formatter: Self.FormatReturnedTime },
                    { key: false, width: 80, name: "Requestor", index: "8", editable: true, align: "center", sortable: false, hidden: false }
                ],
                toppager: $("#divPager"),
