...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RequestsArchive]') AND type in (N'U'))
DROP TABLE [dbo].[RequestsArchive]
GO
...
CREATE TABLE [dbo].[RequestsArchive](
